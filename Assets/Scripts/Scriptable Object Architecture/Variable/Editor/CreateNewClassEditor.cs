...
public class CreateNewClassEditor : EditorWindow
{
    ...
    private const string pathToYourScriptTemplate = "Assets/Scripts/Scriptable Object Architecture/Variable/GenericVariable.cs.txt";
    ...
    void OnGUI()
    {
        ...
        {
            ProjectWindowUtil.CreateScriptAssetFromTemplateFile(pathToYourScriptTemplate, _path + SO_Utility.FirstCharToUpper(_typeName) + "Variable.cs");
